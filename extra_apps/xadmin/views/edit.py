...
class ModelFormAdminView(ModelAdminView):
    ...
    def get_form_layout(self):
        ...
        if layout is None:
            layout = Layout(Container(Col('image',
            ...
            if isinstance(layout[0], Column):
                ...
                fs = (Col('image', *layout, horizontal=True, span=12),)
            else:
                fs = (Col('image', Fieldset("", *layout, css_class="unsort no_title"), horizontal=True, span=12),)
