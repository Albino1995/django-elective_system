...
(function($) {
    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        var series = [],
            options = {
                ...
                xaxis: {
                    ...
                    tickLength: null, // size in pixels of ticks, or "image" for whole line
        ...
        function allocateAxisBoxFirstPhase(axis) {
            ...
            // determine tick length - if we're innermost, we can use "image"
            if (tickLength == null) {
